...
if ("undefined" == typeof jQuery) {
    ...
    e.fn.emulateTransitionEnd = function(a) {
        var h = !1,
            g = this;
        ...
        var f = function() {
            h || e(g).trigger(e.support.transition.end)
        };
        return setTimeout(f, a), this
    }, e(function() {
        e.support.transition = c()
    })
}(jQuery), + function(f) {
    ...
    h.prototype.close = function(a) {
        function m() {
            j.trigger("closed.bs.alert").remove()
        }
        var l = f(this),
            k = l.attr("data-target");
        k || (k = l.attr("href"), k = k && k.replace(/.*(?=#[^\s]*$)/, ""));
        var j = f(k);
        a && a.preventDefault(), j.length || (j = l.hasClass("alert") ? l : l.parent()), j.trigger(a = f.Event("close.bs.alert")), a.isDefaultPrevented() || (j.removeClass("in"), f.support.transition && j.hasClass("fade") ? j.one(f.support.transition.end, m).emulateTransitionEnd(150) : m())
    };
    var g = f.fn.alert;
    f.fn.alert = function(a) {
        return this.each(function() {
            var c = f(this),
                b = c.data("bs.alert");
            b || c.data("bs.alert", b = new h(this)), "string" == typeof a && b[a].call(c)
        })
    ...
    var e = function(b, a) {
        this.$element = f(b), this.options = f.extend({}, e.DEFAULTS, a), this.isLoading = !1
    };
    e.DEFAULTS = {
        loadingText: "loading..."
        ...
        var l = "disabled",
            ...
            h = k.data();
        a += "Text", h.resetText || k.data("resetText", k[j]()), k[j](h[a] || this.options[a]), setTimeout(f.proxy(function() {
        ...
        if (h.length) {
            ...
            "radio" == k.prop("type") && (k.prop("checked") && this.$element.hasClass("active") ? j = !1 : h.find(".active").removeClass("active")), j && k.prop("checked", !this.$element.hasClass("active")).trigger("change")
        }
    ...
    f.fn.button = function(a) {
        return this.each(function() {
            var h = f(this),
                c = h.data("bs.button"),
                b = "object" == typeof a && a;
            c || h.data("bs.button", c = new e(this, b)), "toggle" == a ? c.toggle() : a && c.setState(a)
        })
    }, f.fn.button.Constructor = e, f.fn.button.noConflict = function() {
        return f.fn.button = g, this
    }, f(document).on("click.bs.button.data-api", "[data-toggle^=button]", function(a) {
        var h = f(a.target);
        h.hasClass("btn") || (h = h.closest(".btn")), h.button("toggle"), a.preventDefault()
    })
}(jQuery), + function(f) {
    var e = function(a, h) {
        this.$element = f(a), this.$indicators = this.$element.find(".carousel-indicators"), this.options = h, this.paused = this.sliding = this.interval = this.$active = this.$items = null, "hover" == this.options.pause && this.$element.on("mouseenter", f.proxy(this.pause, this)).on("mouseleave", f.proxy(this.cycle, this))
    };
    e.DEFAULTS = {
        interval: 5000,
        pause: "hover",
        ...
        return a > this.$items.length - 1 || 0 > a ? void 0 : this.sliding ? this.$element.one("slid.bs.carousel", function() {
            j.to(a)
        }) : h == a ? this.pause().cycle() : this.slide(a > h ? "next" : "prev", f(this.$items[a]))
    ...
    }, e.prototype.slide = function(r, q) {
        ...
        var a = f.Event("slide.bs.carousel", {
            relatedTarget: o[0],
            direction: m
        });
        return this.$element.trigger(a), a.isDefaultPrevented() ? void 0 : (this.sliding = !0, n && this.pause(), this.$indicators.length && (this.$indicators.find(".active").removeClass("active"), this.$element.one("slid.bs.carousel", function() {
            var c = f(k.$indicators.children()[k.getActiveIndex()]);
            c && c.addClass("active")
        })), f.support.transition && this.$element.hasClass("slide") ? (o.addClass(r), o[0].offsetWidth, p.addClass(m), o.addClass(m), p.one(f.support.transition.end, function() {
        ...
        }).emulateTransitionEnd(1000 * p.css("transition-duration").slice(0, -1))) : (p.removeClass("active"), o.addClass("active"), this.sliding = !1, this.$element.trigger("slid.bs.carousel")), n && this.cycle(), this)
    };
    var g = f.fn.carousel;
    f.fn.carousel = function(a) {
        return this.each(function() {
            var j = f(this),
                h = j.data("bs.carousel"),
                c = f.extend({}, e.DEFAULTS, j.data(), "object" == typeof a && a),
                b = "string" == typeof a ? a : c.slide;
            h || j.data("bs.carousel", h = new e(this, c)), "number" == typeof a ? h.to(a) : b ? h[b]() : c.interval && h.pause().cycle()
        })
    }, f.fn.carousel.Constructor = e, f.fn.carousel.noConflict = function() {
        return f.fn.carousel = g, this
    }, f(document).on("click.bs.carousel.data-api", "[data-slide], [data-slide-to]", function(a) {
        var m, l = f(this),
            k = f(l.attr("data-target") || (m = l.attr("href")) && m.replace(/.*(?=#[^\s]+$)/, "")),
            j = f.extend({}, k.data(), l.data()),
            h = l.attr("data-slide-to");
        h && (j.interval = !1), k.carousel(j), (h = l.attr("data-slide-to")) && k.data("bs.carousel").to(h), a.preventDefault()
    ...
    var e = function(b, a) {
        this.$element = f(b), this.options = f.extend({}, e.DEFAULTS, a), this.transitioning = null, this.options.parent && (this.$parent = f(this.options.parent)), this.options.toggle && this.toggle()
    };
    e.DEFAULTS = {
        toggle: !0
        ...
        if (!this.transitioning && !this.$element.hasClass("in")) {
            var a = f.Event("show.bs.collapse");
            if (this.$element.trigger(a), !a.isDefaultPrevented()) {
                var m = this.$parent && this.$parent.find("> .panel > .in");
                if (m && m.length) {
                    var l = m.data("bs.collapse");
                    if (l && l.transitioning) {
                        return
                    }
                    m.collapse("hide"), l || m.data("bs.collapse", null)
                }
                ...
                var h = f.camelCase(["scroll", k].join("-"));
                this.$element.one(f.support.transition.end, f.proxy(j, this)).emulateTransitionEnd(350)[k](this.$element[0][h])
            }
        }
        ...
        if (!this.transitioning && this.$element.hasClass("in")) {
            ...
            if (this.$element.trigger(a), !a.isDefaultPrevented()) {
                ...
                return f.support.transition ? void this.$element[j](0).one(f.support.transition.end, f.proxy(h, this)).emulateTransitionEnd(350) : h.call(this)
            }
        }
    }, e.prototype.toggle = function() {
    ...
    f.fn.collapse = function(a) {
        return this.each(function() {
            var h = f(this),
                c = h.data("bs.collapse"),
                b = f.extend({}, e.DEFAULTS, h.data(), "object" == typeof a && a);
            !c && b.toggle && "show" == a && (a = !a), c || h.data("bs.collapse", c = new e(this, b)), "string" == typeof a && c[a]()
        })
    }, f.fn.collapse.Constructor = e, f.fn.collapse.noConflict = function() {
    ...
    l.prototype.toggle = function(q) {
        ...
        if (!p.is(".disabled, :disabled")) {
            var c = o(p),
                b = c.hasClass("open");
            if (h(), !b) {
                "ontouchstart" in document.documentElement && !c.closest(".navbar-nav").length && j('<div class="dropdown-backdrop"/>').insertAfter(j(this)).on("click", h);
                var a = {
                    relatedTarget: this
                };
                if (c.trigger(q = j.Event("show.bs.dropdown", a)), q.isDefaultPrevented()) {
                    return
                }
                c.toggleClass("open").trigger("shown.bs.dropdown", a), p.focus()
            }
            return !1
        }
        ...
        if (/(38|40|27)/.test(a.keyCode)) {
            var s = j(this);
            if (a.preventDefault(), a.stopPropagation(), !s.is(".disabled, :disabled")) {
                var r = o(s),
                    q = r.hasClass("open");
                if (!q || q && 27 == a.keyCode) {
                    return 27 == a.which && r.find(m).focus(), s.click()
                }
                var p = " li:not(.divider):visible a",
                    e = r.find("[role=menu]" + p + ", [role=listbox]" + p);
                if (e.length) {
                    var c = e.index(e.filter(":focus"));
                    38 == a.keyCode && c > 0 && c--, 40 == a.keyCode && c < e.length - 1 && c++, ~c || (c = 0), e.eq(c).focus()
                }
            }
        }
    };
    ...
    var e = function(a, h) {
        this.options = h, this.$element = f(a), this.$backdrop = this.isShown = null, this.options.remote && this.$element.find(".modal-content").load(this.options.remote, f.proxy(function() {
    ...
    e.DEFAULTS = {
        ...
        var j = this,
            h = f.Event("show.bs.modal", {
                relatedTarget: a
            });
        this.$element.trigger(h), this.isShown || h.isDefaultPrevented() || (this.isShown = !0, this.escape(), this.$element.on("click.dismiss.bs.modal", '[data-dismiss="modal"]', f.proxy(this.hide, this)), this.backdrop(function() {
            var c = f.support.transition && j.$element.hasClass("fade");
            j.$element.parent().length || j.$element.appendTo(document.body), j.$element.show().scrollTop(0), c && j.$element[0].offsetWidth, j.$element.addClass("in").attr("aria-hidden", !1), j.enforceFocus();
            var b = f.Event("shown.bs.modal", {
                relatedTarget: a
            });
            c ? j.$element.find(".modal-dialog").one(f.support.transition.end, function() {
                j.$element.focus().trigger(b)
            }).emulateTransitionEnd(300) : j.$element.focus().trigger(b)
        }))
    }, e.prototype.hide = function(a) {
        a && a.preventDefault(), a = f.Event("hide.bs.modal"), this.$element.trigger(a), this.isShown && !a.isDefaultPrevented() && (this.isShown = !1, this.escape(), f(document).off("focusin.bs.modal"), this.$element.removeClass("in").attr("aria-hidden", !0).off("click.dismiss.bs.modal"), f.support.transition && this.$element.hasClass("fade") ? this.$element.one(f.support.transition.end, f.proxy(this.hideModal, this)).emulateTransitionEnd(300) : this.hideModal())
        ...
        if (this.isShown && this.options.backdrop) {
            var h = f.support.transition && j;
            if (this.$backdrop = f('<div class="modal-backdrop ' + j + '" />').appendTo(document.body), this.$element.on("click.dismiss.bs.modal", f.proxy(function(b) {
            ...
            !this.isShown && this.$backdrop ? (this.$backdrop.removeClass("in"), f.support.transition && this.$element.hasClass("fade") ? this.$backdrop.one(f.support.transition.end, a).emulateTransitionEnd(150) : a()) : a && a()
        }
    };
    var g = f.fn.modal;
    f.fn.modal = function(b, a) {
        return this.each(function() {
            var j = f(this),
                h = j.data("bs.modal"),
                c = f.extend({}, e.DEFAULTS, j.data(), "object" == typeof b && b);
            h || j.data("bs.modal", h = new e(this, c)), "string" == typeof b ? h[b](a) : c.show && h.show(a)
        })
    }, f.fn.modal.Constructor = e, f.fn.modal.noConflict = function() {
        return f.fn.modal = g, this
    }, f(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', function(a) {
        var l = f(this),
            k = l.attr("href"),
            j = f(l.attr("data-target") || k && k.replace(/.*(?=#[^\s]+$)/, "")),
            h = j.data("bs.modal") ? "toggle" : f.extend({
                remote: !/#/.test(k) && k
            }, j.data(), l.data());
        l.is("a") && a.preventDefault(), j.modal(h, this).one("hide", function() {
            l.is(":visible") && l.focus()
        })
    }), f(document).on("show.bs.modal", ".modal", function() {
    ...
    var e = function(h, c) {
        this.type = this.options = this.enabled = this.timeout = this.hoverState = this.$element = null, this.init("tooltip", h, c)
    };
    e.DEFAULTS = {
        animation: !0,
        placement: "top",
        ...
        html: !1,
        container: !1
    }, e.prototype.init = function(a, p, o) {
        this.enabled = !0, this.type = a, this.$element = f(p), this.options = this.getOptions(o);
        ...
        var h = a instanceof this.constructor ? a : f(a.currentTarget)[this.type](this.getDelegateOptions()).data("bs." + this.type);
        ...
        var H = f.Event("show.bs." + this.type);
        if (this.hasContent() && this.enabled) {
            ...
            var E = "function" == typeof this.options.placement ? this.options.placement.call(this, F[0], this.$element[0]) : this.options.placement,
                D = /\s?auto?\s?/i,
                C = D.test(E);
            C && (E = E.replace(D, "") || "top"), F.detach().css({
                top: 0,
                left: 0,
                display: "block"
            }).addClass(E), this.options.container ? F.appendTo(this.options.container) : F.insertAfter(this.$element);
            ...
            if (C) {
                var y = this.$element.parent(),
                    ...
                    v = "body" == this.options.container ? window.innerWidth : y.outerWidth(),
                    u = "body" == this.options.container ? window.innerHeight : y.outerHeight(),
            ...
            f.support.transition && this.$tip.hasClass("fade") ? F.one(f.support.transition.end, a).emulateTransitionEnd(150) : a()
        }
    }, e.prototype.applyPlacement = function(v, u) {
        var t, s = this.tip(),
            r = s[0].offsetWidth,
            q = s[0].offsetHeight,
            p = parseInt(s.css("margin-top"), 10),
            o = parseInt(s.css("margin-left"), 10);
        isNaN(p) && (p = 0), isNaN(o) && (o = 0), v.top = v.top + p, v.left = v.left + o, f.offset.setOffset(s[0], f.extend({
            using: function(b) {
                s.css({
        ...
        t && s.offset(v)
    }, e.prototype.replaceArrow = function(j, h, k) {
        ...
        var k = this,
            j = this.tip(),
            h = f.Event("hide.bs." + this.type);
        return this.$element.trigger(h), h.isDefaultPrevented() ? void 0 : (j.removeClass("in"), f.support.transition && this.$tip.hasClass("fade") ? j.one(f.support.transition.end, a).emulateTransitionEnd(150) : a(), this.hoverState = null, this)
    ...
    }, e.prototype.getCalculatedOffset = function(j, h, l, k) {
        return "bottom" == j ? {
            top: h.top + h.height,
        ...
        var h = a ? f(a.currentTarget)[this.type](this.getDelegateOptions()).data("bs." + this.type) : this;
    ...
    f.fn.tooltip = function(a) {
        return this.each(function() {
            var h = f(this),
                c = h.data("bs.tooltip"),
                b = "object" == typeof a && a;
            (c || "destroy" != a) && (c || h.data("bs.tooltip", c = new e(this, b)), "string" == typeof a && c[a]())
        })
    }, f.fn.tooltip.Constructor = e, f.fn.tooltip.noConflict = function() {
    ...
    e.DEFAULTS = f.extend({}, f.fn.tooltip.Constructor.DEFAULTS, {
        placement: "right",
        trigger: "click",
        content: "",
        template: '<div class="popover"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>'
    }), e.prototype = f.extend({}, f.fn.tooltip.Constructor.prototype), e.prototype.constructor = e, e.prototype.getDefaults = function() {
        return e.DEFAULTS
    }, e.prototype.setContent = function() {
        var j = this.tip(),
            h = this.getTitle(),
            k = this.getContent();
        j.find(".popover-title")[this.options.html ? "html" : "text"](h), j.find(".popover-content")[this.options.html ? "string" == typeof k ? "html" : "append" : "text"](k), j.removeClass("fade top bottom left right in"), j.find(".popover-title").html() || j.find(".popover-title").hide()
    }, e.prototype.hasContent = function() {
    ...
    f.fn.popover = function(a) {
        return this.each(function() {
            var h = f(this),
                c = h.data("bs.popover"),
                b = "object" == typeof a && a;
            (c || "destroy" != a) && (c || h.data("bs.popover", c = new e(this, b)), "string" == typeof a && c[a]())
        })
    }, f.fn.popover.Constructor = e, f.fn.popover.noConflict = function() {
        return f.fn.popover = g, this
    }
}(jQuery), + function(f) {
    function e(j, h) {
        var b, a = f.proxy(this.process, this);
        this.$element = f(f(j).is("body") ? window : j), this.$body = f("body"), this.$scrollElement = this.$element.on("scroll.bs.scroll-spy.data-api", a), this.options = f.extend({}, e.DEFAULTS, h), this.selector = (this.options.target || (b = f(j).attr("href")) && b.replace(/.*(?=#[^\s]+$)/, "") || "") + " .nav li > a", this.offsets = f([]), this.targets = f([]), this.activeTarget = null, this.refresh(), this.process()
    }
    e.DEFAULTS = {
        offset: 10
    }, e.prototype.refresh = function() {
        var a = this.$element[0] == window ? "offset" : "position";
        this.offsets = f([]), this.targets = f([]);
        var h = this;
        this.$body.find(this.selector).map(function() {
            var j = f(this),
                c = j.data("target") || j.attr("href"),
                b = /^#./.test(c) && f(c);
            return b && b.length && b.is(":visible") && [
                [b[a]().top + (!f.isWindow(h.$scrollElement.get(0)) && h.$scrollElement.scrollTop()), c]
            ] || null
        }).sort(function(j, c) {
            return j[0] - c[0]
        }).each(function() {
        ...
        for (j = m.length; j--;) {
            k != l[j] && h >= m[j] && (!m[j + 1] || h <= m[j + 1]) && this.activate(l[j])
        }
        ...
        var j = this.selector + '[data-target="' + a + '"],' + this.selector + '[href="' + a + '"]',
            h = f(j).parents("li").addClass("active");
    ...
    f.fn.scrollspy = function(a) {
        return this.each(function() {
            var h = f(this),
                c = h.data("bs.scrollspy"),
                b = "object" == typeof a && a;
            c || h.data("bs.scrollspy", c = new e(this, b)), "string" == typeof a && c[a]()
        })
    }, f.fn.scrollspy.Constructor = e, f.fn.scrollspy.noConflict = function() {
    ...
    e.prototype.show = function() {
        ...
        if (l || (l = a.attr("href"), l = l && l.replace(/.*(?=#[^\s]*$)/, "")), !a.parent("li").hasClass("active")) {
            var k = m.find(".active:last a")[0],
                j = f.Event("show.bs.tab", {
                    relatedTarget: k
                });
            if (a.trigger(j), !j.isDefaultPrevented()) {
                var h = f(l);
                this.activate(a.parent("li"), m), this.activate(h, h.parent(), function() {
                    a.trigger({
                        type: "shown.bs.tab",
                        relatedTarget: k
                    })
    ...
    }, e.prototype.activate = function(a, m, l) {
        function k() {
            j.removeClass("active").find("> .dropdown-menu > .active").removeClass("active"), a.addClass("active"), h ? (a[0].offsetWidth, a.addClass("in")) : a.removeClass("fade"), a.parent(".dropdown-menu") && a.closest("li.dropdown").addClass("active"), l && l()
        }
        var j = m.find("> .active"),
            h = l && f.support.transition && j.hasClass("fade");
        h ? j.one(f.support.transition.end, k).emulateTransitionEnd(150) : k(), j.removeClass("in")
    };
    var g = f.fn.tab;
    f.fn.tab = function(a) {
        return this.each(function() {
            var c = f(this),
                b = c.data("bs.tab");
            b || c.data("bs.tab", b = new e(this)), "string" == typeof a && b[a]()
        })
    }, f.fn.tab.Constructor = e, f.fn.tab.noConflict = function() {
    ...
    var e = function(b, a) {
        this.options = f.extend({}, e.DEFAULTS, a), this.$window = f(window).on("scroll.bs.affix.data-api", f.proxy(this.checkPosition, this)).on("click.bs.affix.data-api", f.proxy(this.checkPositionWithEventLoop, this)), this.$element = f(b), this.affixed = this.unpin = this.pinnedOffset = null, this.checkPosition()
    };
    e.RESET = "affix affix-top affix-bottom", e.DEFAULTS = {
        ...
        if (this.$element.is(":visible")) {
            ...
            if (this.affixed !== l) {
                ...
                var b = "affix" + (l ? "-" + l : ""),
                    a = f.Event(b + ".bs.affix");
                this.$element.trigger(a), a.isDefaultPrevented() || (this.affixed = l, this.unpin = "bottom" == l ? this.getPinnedOffset() : null, this.$element.removeClass(e.RESET).addClass(b).trigger(f.Event(b.replace("affix", "affixed"))), "bottom" == l && this.$element.offset({
                    top: r - m - this.$element.height()
                }))
            }
        }
    };
    ...
    f.fn.affix = function(a) {
        return this.each(function() {
            var h = f(this),
                c = h.data("bs.affix"),
                b = "object" == typeof a && a;
            c || h.data("bs.affix", c = new e(this, b)), "string" == typeof a && c[a]()
        })
    }, f.fn.affix.Constructor = e, f.fn.affix.noConflict = function() {
...
function lectoraActivation() {
    ...
    if (a == "") {
        lectoraErrorAlert("Please fill in your Lectora Online User ID.")
    } else {
        if (c == "") {
            lectoraErrorAlert("Please fill in the password for your Lectora Online account.")
        } else {
...
jQuery(function(a) {
    a(".clear-search-handler input[type=text]").each(function() {
        if ("" != a(this).val()) {
            a(this).closest(".clear-search-handler").find(".clear-search-button").show()
        }
    });
    a("body").on("change.search.clear, keyup.search.clear", ".clear-search-handler input[type=text]", function(b) {
        if ("" != a(this).val()) {
            a(this).closest(".clear-search-handler").find(".clear-search-button").show()
        } else {
            a(this).closest(".clear-search-handler").find(".clear-search-button").hide()
        }
    }).on("click.search.clear", ".clear-search-handler .clear-search-button", function(b) {
        a(this).closest(".clear-search-handler").find("input[type=text]").val("").keyup();
        if (!a(this).data("prevent-submit")) {
...
Gettext.prototype.parse_locale_data = function(g) {
    if (typeof(Gettext._locale_data) == "undefined") {
        Gettext._locale_data = {}
    }
    for (var f in g) {
        if ((!g.hasOwnProperty(f)) || (!this.isValidObject(g[f]))) {
            continue
        }
        var b = false;
        for (var a in g[f]) {
        ...
        if (!this.isValidObject(Gettext._locale_data[f])) {
            Gettext._locale_data[f] = {}
        }
        if (!this.isValidObject(Gettext._locale_data[f].head)) {
            Gettext._locale_data[f].head = {}
        }
        if (!this.isValidObject(Gettext._locale_data[f].msgs)) {
        ...
        for (var p in j) {
            if (p == "") {
                ...
                for (var o in l) {
                    var k = o.toLowerCase();
                    Gettext._locale_data[f].head[k] = l[o]
                }
            } else {
                Gettext._locale_data[f].msgs[p] = j[p]
            }
        }
    }
    for (var f in Gettext._locale_data) {
        if (this.isValidObject(Gettext._locale_data[f].head["plural-forms"]) && typeof(Gettext._locale_data[f].head.plural_func) == "undefined") {
            var n = Gettext._locale_data[f].head["plural-forms"];
            var e = new RegExp("^(\\s*nplurals\\s*=\\s*[0-9]+\\s*;\\s*plural\\s*=\\s*(?:\\s|[-\\?\\|&=!<>+*/%:;a-zA-Z0-9_()])+)", "m");
            if (e.test(n)) {
                var m = Gettext._locale_data[f].head["plural-forms"];
                if (!/;\s*$/.test(m)) {
                    m = m.concat(";")
                }
                var c = "var plural; var nplurals; " + m + ' return { "nplural" : nplurals, "plural" : (plural === true ? 1 : plural ? plural : 0) };';
                Gettext._locale_data[f].head.plural_func = new Function("n", c)
            } else {
                throw new Error("Syntax error in language file. Plural-Forms header is invalid [" + n + "]")
            }
        } else {
            if (typeof(Gettext._locale_data[f].head.plural_func) == "undefined") {
                Gettext._locale_data[f].head.plural_func = function(q) {
                    var h = (q != 1) ? 1 : 0;
                    return {
                        nplural: 2,
                        plural: h
...
Gettext.prototype.parse_po = function(r) {
    var f = {};
    var m = {};
    var k = "";
    var h = [];
    ...
    for (var o = 0; o < a.length; o++) {
        ...
        var g;
        if (/^$/.test(a[o])) {
            if (typeof(m.msgid) != "undefined") {
                var q = (typeof(m.msgctxt) != "undefined" && m.msgctxt.length) ? m.msgctxt + Gettext.context_glue + m.msgid : m.msgid;
                var n = (typeof(m.msgid_plural) != "undefined" && m.msgid_plural.length) ? m.msgid_plural : null;
                var c = [];
                for (var l in m) {
                    var g;
                    if (g = l.match(/^msgstr_(\d+)/)) {
                        c[parseInt(g[1])] = m[l]
                    }
                }
                c.unshift(n);
            ...
            if (/^#/.test(a[o])) {
                ...
                if (g = a[o].match(/^msgctxt\s+(.*)/)) {
                    k = "msgctxt";
                    m[k] = this.parse_po_dequote(g[1])
                } else {
                    if (g = a[o].match(/^msgid\s+(.*)/)) {
                        k = "msgid";
                        m[k] = this.parse_po_dequote(g[1])
                    } else {
                        if (g = a[o].match(/^msgid_plural\s+(.*)/)) {
                            k = "msgid_plural";
                            m[k] = this.parse_po_dequote(g[1])
                        } else {
                            if (g = a[o].match(/^msgstr\s+(.*)/)) {
                                k = "msgstr_0";
                                m[k] = this.parse_po_dequote(g[1])
                            } else {
                                if (g = a[o].match(/^msgstr\[0\]\s+(.*)/)) {
                                    k = "msgstr_0";
                                    m[k] = this.parse_po_dequote(g[1])
                                } else {
                                    if (g = a[o].match(/^msgstr\[(\d+)\]\s+(.*)/)) {
                                        k = "msgstr_" + g[1];
                                        m[k] = this.parse_po_dequote(g[2])
                                    } else {
                                        if (/^"/.test(a[o])) {
                                            m[k] += this.parse_po_dequote(a[o])
                                        } else {
                                            h.push("Strange line [" + o + "] : " + a[o])
                                        }
                                    }
                                }
                            }
    ...
    if (f[""] && f[""][1]) {
        ...
        for (var o = 0; o < p.length; o++) {
            ...
            var e = p[o].indexOf(":", 0);
            if (e != -1) {
                var s = p[o].substring(0, e);
                var t = p[o].substring(e + 1);
                var j = s.toLowerCase();
                if (b[j] && b[j].length) {
                    h.push("SKIPPING DUPLICATE HEADER LINE: " + p[o])
                } else {
                    if (/#-#-#-#-#/.test(j)) {
                        h.push("SKIPPING ERROR MARKER IN HEADER: " + p[o])
                    } else {
                        t = t.replace(/^\s+/, "");
                        b[j] = t
                    }
                ...
                h.push("PROBLEM LINE IN HEADER: " + p[o]);
                b[p[o]] = ""
            }
        }
        f[""] = b
...
Gettext.prototype.gettext = function(c) {
    ...
    var e;
    var b;
    return this.dcnpgettext(null, f, c, a, e, b)
};
Gettext.prototype.dgettext = function(e, c) {
    var g;
    var a;
    var f;
    var b;
    return this.dcnpgettext(e, g, c, a, f, b)
};
Gettext.prototype.dcgettext = function(e, c, b) {
    var g;
    var a;
    var f;
    return this.dcnpgettext(e, g, c, a, f, b)
};
Gettext.prototype.ngettext = function(c, a, f) {
    var e;
    var b;
    return this.dcnpgettext(null, e, c, a, f, b)
};
Gettext.prototype.dngettext = function(e, c, a, g) {
    var f;
    var b;
    return this.dcnpgettext(e, f, c, a, g, b)
};
Gettext.prototype.dcngettext = function(e, c, a, g, b) {
    var f;
    return this.dcnpgettext(e, f, c, a, g, b, b)
};
Gettext.prototype.pgettext = function(f, c) {
    var a;
    var e;
    var b;
    return this.dcnpgettext(null, f, c, a, e, b)
};
Gettext.prototype.dpgettext = function(e, g, c) {
    var a;
    var f;
    var b;
    return this.dcnpgettext(e, g, c, a, f, b)
};
Gettext.prototype.dcpgettext = function(e, g, c, b) {
    var a;
    var f;
    return this.dcnpgettext(e, g, c, a, f, b)
};
Gettext.prototype.npgettext = function(f, c, a, e) {
    var b;
    return this.dcnpgettext(null, f, c, a, e, b)
};
Gettext.prototype.dnpgettext = function(e, g, c, a, f) {
    var b;
    return this.dcnpgettext(e, g, c, a, f, b)
};
Gettext.prototype.dcnpgettext = function(z, f, y, t, m, q) {
    if (!this.isValidObject(y)) {
        return ""
    }
    var h = this.isValidObject(t);
    var v = this.isValidObject(f) ? f + Gettext.context_glue + y : y;
    var a = this.isValidObject(z) ? z : this.isValidObject(this.domain) ? this.domain : "messages";
    var x = "LC_MESSAGES";
    var q = 5;
    var o = new Array();
    if (typeof(Gettext._locale_data) != "undefined" && this.isValidObject(Gettext._locale_data[a])) {
        o.push(Gettext._locale_data[a])
    } else {
        if (typeof(Gettext._locale_data) != "undefined") {
            for (var w in Gettext._locale_data) {
                o.push(Gettext._locale_data[w])
            }
        }
    }
    var b = [];
    ...
    if (o.length) {
        for (var u = 0; u < o.length; u++) {
            var s = o[u];
            if (this.isValidObject(s.msgs[v])) {
                for (var r = 0; r < s.msgs[v].length; r++) {
                    b[r] = s.msgs[v][r]
                }
                b.shift();
                l = s;
    ...
    if (h) {
        var k;
        if (g && this.isValidObject(l.head.plural_func)) {
            var c = l.head.plural_func(m);
            if (!c.plural) {
                c.plural = 0
            }
            if (!c.nplural) {
        ...
        if (this.isValidObject(b[k])) {
            e = b[k]
        }
    }
    return e
};
Gettext.strargs = function(h, c) {
    ...
    while (true) {
        ...
        if (h.substr(e, 2) == "%%") {
            ...
            if (a = h.substr(e).match(/^%(\d+)/)) {
                var f = parseInt(a[1]);
                var b = a[1].length;
                if (f > 0 && c[f - 1] != null && typeof(c[f - 1]) != "undefined") {
                    g += c[f - 1]
                }
                h = h.substr((e + 1 + b))
            } else {
...
Gettext.prototype.sjax = function(f) {
    var c;
