...
Importer.prototype.onAssetDelete = function(c, b) {
...
Importer.prototype.onImageFrameSelect = function() {
    this.$el.addClass("is-for-image-frame")
};
Importer.prototype.onImageFrameDeselect = function() {
    this.$el.removeClass("is-for-image-frame")
};
Importer.prototype.shareMode = function(a) {
    if (a === undefined) {
...
Importer.prototype.getImportedAssets = function() {
...
ImporterFile.defaults.options = {
    accept_mime: ["image/png", "image/jpeg", "image/gif", "image/bmp", "audio/mpeg", "audio/wav", "audio/x-wav", "audio/vnd.wave", "audio/wave", "audio/mp3", "audio/mp4", "audio/ogg", "audio/vorbis", "audio/aac", "audio/m4a", "audio/x-m4a", "application/mp4", "video/mp4", "video/mpeg4", "video/x-flv", "video/x-ms-wmv"],
    restricted_mime: [],
